...
from agents.resume_maker import ResumeMaker
from agents.job_search import JobSearch
...
def handle_resume_making(state: State) -> State:
    """Generate a customized resume based on user details for a tech role in AI."""
...
def interview_topics_questions(state: State) -> State:
    """Provide a curated list of interview questions related to Generative AI."""
